...
public class Utils {
	...
	/**
	 * Verifica si el String ingresado es un int.
	 *
	 * @param entrada String a procesar
	 * @return boolean indicando si el String ingresado es un int
	 ...
	 */
	public static String generarNit(String stringIngresado) {
